...
theo_sd <- read_csv("~/ACOP-2019-Intro-R-4-Drug-Development-Workshop/nlmixr/theo_sd.csv")
...
function(input, output) {
  ...
  output$table <- DT::renderDataTable({
    DT::datatable({
    data <- read_csv("~/ACOP-2019-Intro-R-4-Drug-Development-Workshop/nlmixr/theo_sd.csv")
    if (input$CMT != "All") {
